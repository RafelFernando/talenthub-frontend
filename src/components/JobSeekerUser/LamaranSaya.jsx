    ...
    return (
        <div className="p-6 bg-gray-100 min-h-screen">
            <div className="bg-white rounded-lg shadow p-5">
                <h2 className="text-xl font-semibold text-gray-800 mb-5">Lamaran Saya</h2>
                    ...
                    <div className="flex flex-col gap-4">
                        {jobsToShow.map((job) => (
                            ...
                            >
                                ...
                                <button className="flex items-center gap-1 mt-3 sm:mt-0 bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded text-sm transition">
                                    <Eye size={16} /> Detail
                                </button>
                            </div>
                        ))}
